...
function AddNewProduct():ReactElement{
        ...
        onSubmit:(async(values)=>{
            if(auth){
                try{
                    ...
                    if(e){
                        makeModal((((e as AxiosError)?.response?.data) as errorType)?.status,"Adding Product",(((e as AxiosError)?.response?.data) as errorType)?.message)
                    }
               }
            }else{
                Swal.fire({
  ...
  return (
    <div className='p-4 rounded-2 position-absolute top-0 start-0 bottom-0 end-0 bg-primary d-flex justify-content-center align-items-center flex-column'>
        <form onSubmit={(e)=>{
            ...
            <h1 className='text-primary text-start text-capitalize bg-light mb-3'>Add Prodcut</h1>
            <div className='row justify-content-between mb-3'>
                ...
                <div className="col">
                    <div className="col-5 input-group">
                        ...
                        <input type="text" className="form-control" name='description' onChange={formik.handleChange} onBlur={formik.handleBlur} id="exampleInputdescription" />
                        <div className="invalid-feedback">
            ...
            <div className='row justify-content-between mb-3'>
                <div className="col">
                    <div className="input-group">
                        ...
                        <input type="text" className="form-control" name='price' onChange={formik.handleChange} onBlur={formik.handleBlur} id="exampleInputprice" />
                        <div className="invalid-feedback">
                ...
                <div className="col">
                    <div className="input-group">
                        ...
                        <input type="text" className="form-control" name='inStock' onChange={formik.handleChange} onBlur={formik.handleBlur} id="exampleInputinStock" />
                        <div className="invalid-feedback">
            ...
            <div className='row justify-content-between mb-3'>
                <div className="col">
                    <div className="input-group">
                        ...
                        <select className="form-select"  name='category' onChange={formik.handleChange} onBlur={formik.handleBlur}>
                ...
                <div className="col">
                    <div className="input-group">
                        <label htmlFor="exampleInputcompany" className="input-group-text">Company</label>
                        <select className="form-select"  name='company' onChange={formik.handleChange} onBlur={formik.handleBlur}>
            ...
            <div className="btn-group mb-3" role="group" aria-label="Basic checkbox toggle button group">
                <input type="checkbox" name='sizes' className="btn-check" id="btncheck1" value={'s'} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                <label className="btn btn-outline-primary text-black" htmlFor="btncheck1">small</label>

                <input type="checkbox" name='sizes' className="btn-check" id="btncheck2" value={'m'} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                <label className="btn btn-outline-primary text-black" htmlFor="btncheck2">mediumn</label>

                <input type="checkbox" name='sizes' className="btn-check" id="btncheck3" value={'l'} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
                <label className="btn btn-outline-primary text-black" htmlFor="btncheck3">large</label>

                <input type="checkbox" name='sizes' className="btn-check" id="btncheck4" value={'xl'} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
